This program taught me that having 'if' statements inside 'if' statements is possible. I had almost forgotten about that. I have been doing if/elif/else statements for a while now.

This program just takes an input of a year and will output whether or not it's a leap year.
